...
CLASSPATH=$CLASSPATH:$LIB_DIR/activation-1.1.1.jar
...
CLASSPATH=$CLASSPATH:$LIB_DIR/org.graylog2.gelfj-1.0.2.jar
CLASSPATH=$CLASSPATH:$LIB_DIR/guice-3.0.jar
CLASSPATH=$CLASSPATH:$LIB_DIR/hibernate-core-3.6.3.Final.jar
...
CLASSPATH=$CLASSPATH:$LIB_DIR/slf4j-api-1.7.26.jar
...
CLASSPATH=$CLASSPATH:$LIB_DIR/javax.mail-1.6.2.jar
CLASSPATH=$CLASSPATH:$LIB_DIR/pdfbox-app-2.0.21.jar
...
cd $PORTLET_ROOT
$JAVA_HOME/bin/java -classpath $CLASSPATH edu.osu.cws.evals.backend.BackupPDFsInjector
