...
<portlet:resourceURL var="dontsaveDraftAJAXURL" id="update" escapeXml="false" />
...
<div>
    <form id="testForm">
        ...
        <input name="${permissionRule.saveDraft}" type="submit" value="<liferay-ui:message key="${dontsaveDraftAJAXURL}" />">
    </form>
</div>
